...
#include <string.h>
#include <stdbool.h>
/** @brief Total de empleados que maneja el ejemplo. */
#define MAX 3

/**
 * @brief Registro básico de un empleado dentro del ejercicio interactivo.
 */
struct empleado
{
    int codigo;       /**< Identificador único del empleado. */
    char nombre[40];  /**< Nombre completo capturado por el usuario. */
    float salario;    /**< Salario registrado para el empleado. */
};
