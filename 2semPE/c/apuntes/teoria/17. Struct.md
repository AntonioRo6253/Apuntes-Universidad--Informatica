...
### Declaración Combinada (Definición + Variables)
...
int main() {
    struct jugador jugador1 = {.nombre = "Inicial", .nivel = 1, .salud = 100};
...
`typedef` crea un **alias (sinónimo)** para tipos de datos existentes, eliminando la necesidad de usar `struct` repetidamente.
